...
object Constants {
    ...
    const val DATA_BASE_NAME: String = "MY_DATABASE"
    const val DATA_BASE_VERSION: Int = 1
    const val DATA_BASE_VERSION_TWO: Int = 2
    ...
    const val PERSON_NUMBER : String = "number"
    ...
    //Database migration
    const val DATA_BASE_MIGRATION_NAME = "DATABASE"
